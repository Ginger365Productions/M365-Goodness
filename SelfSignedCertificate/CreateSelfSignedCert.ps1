...
$certPath = 'C:\Users\malco\Documents\MSIXCodeCert.pfx'
$certPassword = ConvertTo-SecureString -String 'Tr33H0u53!!' -AsPlainText -Force
...
$publicKeyPath = 'C:\Users\malco\Documents\CodeCert.cer'
